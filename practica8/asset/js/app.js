...
formulario[3].addEventListener("keyup", (evt) => {
    if(formulario[3].value <= 0){
        formulario[3].style = "border: 5px solid red";
    } else if(formulario[3].value > 0){
        formulario[3].style = "border: 5px solid green";
    }
});

formulario[2].addEventListener("keyup", (evt) => {
    if(formulario[2].value == ""){
        formulario[2].style = "border: 5px solid red";
    } else{
        formulario[2].style = "border: 5px solid green";
    }
});
...
formulario[1].addEventListener("focusout", (evt) => {
    if(formulario[1].value == ""){
        formulario[1].style = "border: 5px solid red";
    } else{
        formulario[1].style = "border: 5px solid green";
    }
});
